<?php
/**
 * Comics Vault functions and definitions
 *
...
if ( ! function_exists( 'comics_vault_setup' ) ) :
	...
	function comics_vault_setup() {
		 ...
		 * If you're building a theme based on Comics Vault, use a find and replace
		 * to change 'comics-vault' to the name of your theme in all the template files.
		 */
...
function comics_vault_scripts() {
	wp_enqueue_style( 'comics-vault-style', get_stylesheet_uri() );
