...
public class Deck : MonoBehaviour
{
	...
	{
		// This creates an anchor for all the Card GameObjects in the Hiearchy
	...
	public void ReadDeck ( string deckXMLText )
	{
		...
		xmlr.Parse ( deckXMLText ) ;	// Use that PT+XMLReader to parse DeckXML
		...
		for ( int i = 0 ;  i < xDecos.Count ;  i++ )
		{
			...
			// Set the bool flip based on whether the text of the attribute is "1 or something else. This is an atypical
			// but perfectly fine use of the == comparison operator. It will return a true or false, which will be
			// assigned to deco.flip.
	...
	public void MakeCards()
	{
		...
		for ( int i = 0 ;  i < cardNames.Count ;  i++ )
		{
			...
			foreach ( Decorator deco in decorators )
			{
				...
				// Add this decoGameObject to the List card.decoGOs
