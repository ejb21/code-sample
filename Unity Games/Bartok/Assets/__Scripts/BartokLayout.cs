...
public class BartokLayout : MonoBehaviour
{
	...
	public PT_XMLHashtable		xml ;			// This variable is for faster xml acccess
	...
	public void ReadLayout ( string xmlText )
	{
		...
		for ( int i = 0 ;  i < slotsX.Count ;  i++ )
		{
			...
			// The layers are used to make sure that the orrect cards are on top of the others. In Unity 2D, all of
			// our assets are effectively at the same Z depth, so sorting layers are used to differentiate between them.
