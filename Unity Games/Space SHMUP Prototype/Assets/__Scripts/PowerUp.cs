...
public class PowerUp : MonoBehaviour {
	...
	// This is an unusual but handy use of Vector2s. x holds a min value and y a max value for a Random.Range() that will be called later
	...
	public Vector3		rotPerSecond ;			// Enter rotation speed
