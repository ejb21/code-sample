...
public class Utils : MonoBehaviour {
	...
	public static void SetCameraBounds ( Camera cam = null )
	{
		...
		//		2. The camera is set at a rotation of R:[0,0,0]

		// Make Vector3s at the topLeft and bottomRight of the Screen coordinates
	...
	// This function will iteratively climb the transform.parent tree until it finds a parent with a tag or no parent
