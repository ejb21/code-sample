...
/*	******
		...
		PLEASE USE UnicodeMaze.java FOR THIS PROJECT !!!
		
		
		UnicodeMaze.java will produce much prettier, easier-to-understand output.
		
		However, you must right-click on UnicodeMaze.java within the Package Explorer window,
		select "Properties", and under "Text File Encoding" select "Other" > "UTF-8".
		
		Otherwise, UnicodeMaze.java will not compile.
...
public class Maze
{
	public static void main( String[] args )
	{
		...
		System.out.println() ;
		System.out.println( "***************  NOTE: \"UnicodeMaze.java\" WILL PRODUCE MUCH CLEANER OUTPUT!" ) ;
		System.out.println() ;
		System.out.println() ;
		System.out.println() ;
		System.out.println() ;
