...
<head>
    ...
    <?php
        if (substr($_SERVER['REQUEST_URI'],1,5) == 'betts') echo '<title>Mookie Betts</title>';
        else if (substr($_SERVER['REQUEST_URI'],1,4) == 'cora') echo '<title>Alex Cora</title>';
        else if (substr($_SERVER['REQUEST_URI'],1,6) == 'pearce') echo '<title>Steve Pearce</title>';
        else if (substr($_SERVER['REQUEST_URI'],1,5) == 'price') echo '<title>David Price</title>';
        else if (substr($_SERVER['REQUEST_URI'],1,4) == 'wall') echo '<title>Cora\'s Wall</title>';
        else if (substr($_SERVER['REQUEST_URI'],1,5) == 'login') echo '<title>Login</title>';
        else echo '<title>Red Sox World Champions</title>';
    ?>
...
<body>
    ...
    <nav class="collapse navbar-collapse navbar-nav" id="navbarSupportedContent">
        <div class="container">
            ...
            <a class="nav-item nav-link" id="nav-price" href="price.php"><img src="img/Price-thumbnail.png" alt="David Price"><span>Price</span></a>
